# python mixed_training.py --dataset E:/courses/pyimage/"my code"/9/Houses-dataset/"Houses Dataset"
...
#our final fully connected layer head will have two dense layers
x = Dense(4, activation="relu")(combinedInput)
x = Dense(1, activation="linear")(x)

# our final model will accept categorical/numerical data on MLP input and
# image in th CNN
# output will be price of the house
